...
# file_name = "20241203_16_55_57_timing_vs_frequency_plotandsim_plotdata"
file_name = "20241206_23_07_52_timing_vs_frequency_plotandsim_plotdata"
...
for i, V in enumerate(all_V):
    ...
    axs[i].grid(True)
    # axs[i].set_xlabel("Drive Frequency (Hz)")
    ...
    # axs[i].set_xticks([0.1, 1, 10, 100, 1000, 10000], ["DC", r"$10^0$", "", r"$10^2$", "", r"$10^4$"], fontsize=16)
    # axs[i].set_xticks([0.1, 1, 100, 10000], ["DC", r"$10^0$", r"$10^2$", r"$10^4$"])
    # axs[i].set_yticks([-15, 0, 15, 30, 45])
