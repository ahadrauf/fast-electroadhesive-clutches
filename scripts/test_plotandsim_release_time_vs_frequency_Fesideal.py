...
import csv
# from sim_release_time_20241116 import *
from sim_release_time import *

now = datetime.now()
name_clarifier = "_release_time_vs_frequency_plotandsim_Fesideal"
...
file_loc = "../data/"
file_name = "20241107_16_02_05_timing_vs_frequency_plotdata"
file_name = "20241117_14_03_49_timing_vs_frequency_plotandsim_plotdata"
    ...
    if True:
        for Fes_scalar_ideal in [True, False]:
            ...
            for frequency in frequency_range:
                ...
                # loadcell_start_ratio = np.interp(np.log10(frequency), np.log10(all_freq), loadcell_start_ratios_by_frequency)
            ...
            axs[i].semilogx(freq_sim, tengage_sim, ls='--', c=colors[-2] if Fes_scalar_ideal else colors[-1], lw=2)
