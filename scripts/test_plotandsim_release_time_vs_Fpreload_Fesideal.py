...
# from sim_release_time_20241112_charge import *

now = datetime.now()
name_clarifier = "_release_time_vs_Fpreload_Fesideal"
...
file_loc = "../data/"
file_name = "20241030_10_23_06_release_time_vs_Fpreload_plotdata"
# file_name = "20241116_14_42_09_timing_vs_Fpreload_plotdata"
# file_name = "20241117_14_05_26_timing_vs_Fpreload_plotdata"
...
# all_V, all_x1, all_y1, all_yerr1, all_x2, all_y2, all_yerr2, all_load_cell_engage_times, all_load_cell_disengage_times, all_load_cell_disengage_forces, all_load_cell_preload_forces, all_load_cell_initial_forces, all_load_cell_max_forces = data
...
for i, V in enumerate(all_V):
    ...
    if True:
        # Fpreload_range = np.linspace(min(x), max(x), 3)
        for Fes_scalar_ideal in [True, False]:
            Fpreload_range = np.linspace(min_x, max_x, 25)   # 25)
            Fpreload_sim = []
            trelease_sim = []
            ...
            axs[i].plot(Fpreload_sim, trelease_sim, ls='--', c=colors[-2] if Fes_scalar_ideal else colors[-1], lw=2)
