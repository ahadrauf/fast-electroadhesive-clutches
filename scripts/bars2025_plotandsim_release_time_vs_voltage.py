...
now = datetime.now()
name_clarifier = "_release_time_vs_voltage_bars2025"
...
if True:
    ...
    V_sim = [100.0, 200.0, 300.0]
    trelease_sim = [0.946781446094462, 0.9117747400181264, 0.8972366216344063]
...
# fig2.savefig(save_folder + timestamp + ".svg")
