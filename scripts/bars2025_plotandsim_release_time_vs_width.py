...
now = datetime.now()
name_clarifier = "_release_time_vs_width_bars2025"
...
if True:
    ...
    w_sim = w_pin_range * 1e3
    tengage_sim = np.array([0.8945733496171936, 1.2259435111414019, 1.6747701375175863])
    print(tengage_sim)
...
# (0.8267110073262313, 1.1512988656780845)
# (0.8101261883408513, 1.8139170759803078)
ax2.set_ylim(0.8101261883408513, 1.8139170759803078)
